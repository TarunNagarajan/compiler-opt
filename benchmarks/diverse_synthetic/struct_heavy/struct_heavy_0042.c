...
int main() {
  for(int i=0;i<195;i++) { arr[i].f0=i*1+8; arr[i].f1=i*2+4; arr[i].f2=i*3+5; arr[i].f3=i*4+0; arr[i].f4=i*5+1; arr[i].f5=i*6+1; }
  for(int i=0;i<195-1;i++) for(int j=i+1;j<195;j++)
