; ModuleID = 'data/test_programs/llgen.c'
source_filename = "data/test_programs/llgen.c"
...
9:                                                ; preds = %5
  ...
  %11 = call i32 @square(i32 noundef %10)
...
define dso_local i32 @main() #0 {
  ...
  %6 = call i32 @sum_of_squares(i32 noundef 10)
  store i32 %6, ptr %2, align 4
  %7 = load i32, ptr %2, align 4
  %8 = call i32 (ptr, ...) @__mingw_printf(ptr noundef @.str, i32 noundef %7)
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %3, ptr align 16 @__const.main.a, i64 36, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %4, ptr align 16 @__const.main.b, i64 36, i1 false)
  %9 = getelementptr inbounds [3 x [3 x i32]], ptr %3, i64 0, i64 0
  %10 = getelementptr inbounds [3 x [3 x i32]], ptr %4, i64 0, i64 0
  %11 = getelementptr inbounds [3 x [3 x i32]], ptr %5, i64 0, i64 0
  call void @matrix_multiply(ptr noundef %9, ptr noundef %10, ptr noundef %11)
  %12 = getelementptr inbounds [3 x [3 x i32]], ptr %5, i64 0, i64 0
  %13 = getelementptr inbounds [3 x i32], ptr %12, i64 0, i64 0
  %14 = load i32, ptr %13, align 16
  %15 = call i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.1, i32 noundef %14)
  ret i32 0
}
...
!1 = !DIFile(filename: "data/test_programs/llgen.c", directory: "C:/Users/ultim/compiler-opt")
