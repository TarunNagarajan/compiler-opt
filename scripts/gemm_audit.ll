; ModuleID = 'benchmarks\linear-algebra\gemm.c'
source_filename = "benchmarks\\linear-algebra\\gemm.c"
...
!1 = !DIFile(filename: "benchmarks\\linear-algebra/gemm.c", directory: "C:/Users/ultim/compiler-opt")
