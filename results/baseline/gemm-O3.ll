...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  br i1 %28, label %._crit_edge.us, label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond.not.1, label %._crit_edge.us, label %scalar.ph, !llvm.loop !12
...
._crit_edge.us:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond31.not, label %._crit_edge25, label %.preheader.us, !llvm.loop !13

._crit_edge25:                                    ; preds = %._crit_edge.us, %3
  ret void
}
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge34.split.us.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %._crit_edge34.split.us.us ], [ 0, %.preheader.us.preheader ]
  %10 = mul nuw nsw i64 %indvars.iv42, %7
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.preheader.us
  ...
  %13 = getelementptr inbounds nuw double, ptr %11, i64 %indvars.iv37
  %14 = load double, ptr %13, align 8
  %15 = fmul double %2, %14
  store double %15, ptr %13, align 8
  %invariant.gep.us.us = getelementptr inbounds nuw double, ptr %5, i64 %indvars.iv37
  br i1 %9, label %._crit_edge.us.us.unr-lcssa, label %.lr.ph.us.us.new

.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us, %.lr.ph.us.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.us.us.new ], [ 0, %.lr.ph.us.us ]
  %16 = phi double [ %28, %.lr.ph.us.us.new ], [ %15, %.lr.ph.us.us ]
  ...
  %gep.us.us = getelementptr inbounds nuw double, ptr %invariant.gep.us.us, i64 %20
  %21 = load double, ptr %gep.us.us, align 8
  ...
  %gep.us.us.1 = getelementptr inbounds nuw double, ptr %invariant.gep.us.us, i64 %26
  %27 = load double, ptr %gep.us.us.1, align 8
  %28 = tail call double @llvm.fmuladd.f64(double %25, double %27, double %22)
  store double %28, ptr %13, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.us.us.unr-lcssa, label %.lr.ph.us.us.new, !llvm.loop !14

._crit_edge.us.us.unr-lcssa:                      ; preds = %.lr.ph.us.us.new, %.lr.ph.us.us
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %.lr.ph.us.us.new ]
  %.unr = phi double [ %15, %.lr.ph.us.us ], [ %28, %.lr.ph.us.us.new ]
  br i1 %lcmp.mod.not, label %._crit_edge.us.us, label %._crit_edge.us.us.epilog-lcssa

._crit_edge.us.us.epilog-lcssa:                   ; preds = %._crit_edge.us.us.unr-lcssa
  %29 = getelementptr inbounds nuw double, ptr %12, i64 %indvars.iv.unr
  %30 = load double, ptr %29, align 8
  %31 = fmul double %1, %30
  %32 = mul nuw nsw i64 %indvars.iv.unr, %7
  %gep.us.us.epil = getelementptr inbounds nuw double, ptr %invariant.gep.us.us, i64 %32
  %33 = load double, ptr %gep.us.us.epil, align 8
  %34 = tail call double @llvm.fmuladd.f64(double %31, double %33, double %.unr)
  store double %34, ptr %13, align 8
  br label %._crit_edge.us.us

._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.unr-lcssa, %._crit_edge.us.us.epilog-lcssa
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %exitcond41.not = icmp eq i64 %indvars.iv.next38, %7
  br i1 %exitcond41.not, label %._crit_edge34.split.us.us, label %.lr.ph.us.us, !llvm.loop !15

._crit_edge34.split.us.us:                        ; preds = %._crit_edge.us.us
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond46.not = icmp eq i64 %indvars.iv.next43, %7
  br i1 %exitcond46.not, label %._crit_edge, label %.preheader.us, !llvm.loop !16

._crit_edge:                                      ; preds = %._crit_edge34.split.us.us, %6
  ret void
}
