...
.preheader.lr.ph:                                 ; preds = %3
  ...
  br i1 %6, label %.preheader.us.preheader, label %._crit_edge17

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %wide.trip.count23 = zext nneg i32 %0 to i64
  %min.iters.check = icmp eq i32 %1, 1
  %n.vec = and i64 %4, 2147483646
  %broadcast.splatinsert25 = insertelement <2 x double> poison, double %7, i64 0
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %10 = mul nuw nsw i64 %indvars.iv20, %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %14 = fdiv <2 x double> %13, %broadcast.splat26
...
._crit_edge.us:                                   ; preds = %scalar.ph, %middle.block
  ...
  br i1 %exitcond24.not, label %._crit_edge17, label %.preheader.us, !llvm.loop !13

._crit_edge17:                                    ; preds = %._crit_edge.us, %.preheader.lr.ph, %3
  ret void
}
